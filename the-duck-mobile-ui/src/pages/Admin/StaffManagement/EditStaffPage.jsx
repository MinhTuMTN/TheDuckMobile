...
const RootPageEditStaff = styled(Box)(({ theme }) => ({
    display: "flex",
    width: "100%",
...
const FormEditStaff = styled(Paper)(({ theme }) => ({
    display: "flex",
    flexDirection: "column",
...
function EditStaffPage(props) {
    ...
    return (
        <RootPageEditStaff>
            <FormEditStaff>
                <Typography variant="h3">Chỉnh sửa thông tin nhân viên "{ }"</Typography>
